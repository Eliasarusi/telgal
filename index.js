...
function startRunning() {
    if (numOfLoadedFiles >= 3) {
        bot = new Bot("5760293026:AAFbiuj9IiEqbdZ31uf9Z5USicvC5XN9aYE", chat_id);
        checkNewInput();
...
function checkNewInput() {
    $.getJSON("https://api.telegram.org/bot5760293026:AAFbiuj9IiEqbdZ31uf9Z5USicvC5XN9aYE/getUpdates", function (data) {
        ...
        if (dataPath != undefined) {
            ...
            if (dataPath.message.message_id != noDubleReference) {
                ...
                offsetUrl = "https://api.telegram.org/bot5760293026:AAFbiuj9IiEqbdZ31uf9Z5USicvC5XN9aYE/getUpdates?offset=" + dataPath.update_id;
